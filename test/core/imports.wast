...
(module
  ...
  (import "spectest"
    (item "print_i32" (func $print_i32 (param i32)))
    (item "print_i64" (func $print_i64 (param i64)))
    (item "print_f32" (func $print_f32 (param f32)))
    (item "print_f64" (func $print_f64 (param f64)))
    (item "print_i32_f32" (func $print_i32_f32 (param i32 f32)))
    (item "print_f64_f64" (func $print_f64_f64 (param f64 f64)))
  )
